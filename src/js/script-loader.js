...
var LoaderProtoMethods = {
    ...
    _getMissingDependencies: function(moduleNames) {
        ...
        for (var i = 0; i < moduleNames.length; i++) {
            ...
            var mappedDependencies = configParser.mapDependency(module, module.dependencies);
        ...
        for (var i = 0; i < modules.length; i++) {
            ...
            for (var j = 0; j < module.dependencies.length; j++) {
                ...
                if (dependency === 'exports') {
                    ...
                    var dependencyModule = registeredModules[configParser.mapDependency(module, dependency)];
